            ...
            if ($isEdit) {
                ...
                if ($imagemPath) {
                    ...
                    $sql = "UPDATE fichas_tecnicas SET 
                            ...
                            autonomia_urbana = ?, autonomia_rodovia = ?, oleo_motor = ?, oleo_transmissao = ?, fluido_freio = ?, descricao = ?, versao = ?,
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <form method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Formatos aceitos: JPEG, PNG, WebP. Tamanho máximo: 5MB</p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="versao" name="versao" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-senai-blue focus:border-senai-blue sm:text-sm" 
                                   value="<?php echo htmlspecialchars($dados['versao'] ?? ''); ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="lugares" name="lugares" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-senai-blue focus:border-senai-blue sm:text-sm">
                                ...
                                <option value="1" <?php echo ($dados['lugares'] ?? '') == '1' ? 'selected' : ''; ?>>1</option>
                                ...
                                <option value="6" <?php echo ($dados['lugares'] ?? '') == '6' ? 'selected' : ''; ?>>6</option>
                                <option value="7" <?php echo ($dados['lugares'] ?? '') == '7' ? 'selected' : ''; ?>>7</option>
                                <option value="8" <?php echo ($dados['lugares'] ?? '') == '8' ? 'selected' : ''; ?>>8</option>
                                <option value="9" <?php echo ($dados['lugares'] ?? '') == '9' ? 'selected' : ''; ?>>9</option>
                                <option value="10" <?php echo ($dados['lugares'] ?? '') == '10' ? 'selected' : ''; ?>>10</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="portas" name="portas" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-senai-blue focus:border-senai-blue sm:text-sm">
                                <option value="">Selecione</option>
                                <option value="Não possui" <?php echo ($dados['portas'] ?? '') == 'Não possui' ? 'selected' : ''; ?>>Não possui</option>
                                <option value="1" <?php echo ($dados['portas'] ?? '') == '1' ? 'selected' : ''; ?>>1</option>
                                <option value="2" <?php echo ($dados['portas'] ?? '') == '2' ? 'selected' : ''; ?>>2</option>
                                <option value="3" <?php echo ($dados['portas'] ?? '') == '3' ? 'selected' : ''; ?>>3</option>
                                <option value="4" <?php echo ($dados['portas'] ?? '') == '4' ? 'selected' : ''; ?>>4</option>
                                <option value="6" <?php echo ($dados['portas'] ?? '') == '6' ? 'selected' : ''; ?>>6</option>
                                <option value="7" <?php echo ($dados['portas'] ?? '') == '7' ? 'selected' : ''; ?>>7</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="disposicao" id="disposicao" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-senai-blue focus:border-senai-blue sm:text-sm">
                                <option value="">Selecione</option>
                                <option value="Transversal" <?php echo ($dados['disposicao'] ?? '') == 'Transversal' ? 'selected' : ''; ?>>Transversal</option>
                        ...
                        <div class="form-group">
                           ...
                           <select name="aspiracao" id="aspiracao" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-senai-blue focus:border-senai-blue sm:text-sm">
                                ...
                                <option value="Natural Aspirado" <?php echo ($dados['aspiracao'] ?? '') == 'Natural Aspirado' ? 'selected' : ''; ?>>Natural Aspirado</option>
                                <option value="Turbo compressor" <?php echo ($dados['aspiracao'] ?? '') == 'Turbo compressor' ? 'selected' : ''; ?>>Turbo compressor</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="tipo_cambio" name="tipo_cambio" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-senai-blue focus:border-senai-blue sm:text-sm">
                                ...
                                <option value="Manual / Automático" <?php echo ($dados['cambio'] ?? '') == 'Manual / Automático' ? 'selected' : ''; ?>>Manual / Automático</option>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="form-group">
                            <label for="oleo_motor" class="block text-sm font-medium text-gray-700 mb-1">Óleo do Motor / Capacidade</label>
                        ...
                        <div class="form-group">
                            <label for="oleo_transmissao" class="block text-sm font-medium text-gray-700 mb-1">Óleo de Transmissão / Capacidade</label>
                        ...
                        <div class="form-group">
                            <label for="fluido_freio" class="block text-sm font-medium text-gray-700 mb-1">Fluido de Freio / Capacidade</label>
                ...
                <!-- Descrição -->
                <div class="mb-8">
                    <h3 class="text-xl font-bold senai-blue mb-4">
                        <i class="fas fa-clipboard-list mr-2"></i>Descrição
                    </h3>
                    <div class="form-group">
                        <label for="descricao" class="block text-sm font-medium text-gray-700 mb-1">Descrição do Veículo</label>
                ...
                <div class="botoes-acoes">
                   ...
                   <!-- Botão Cancelar -->
                   <a href="painel_professor.php" class="btn-cancelar">
                     Cancelar
                   </a>
                </div>
            </form>
