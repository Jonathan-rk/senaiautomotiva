...
// Buscar marcas para o carrossel
$stmt_marcas = $pdo->query("SELECT * FROM marcas ORDER BY id DESC");
...
<body class="bg-gray-50">
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12 senai-blue">Marcas Cadastradas</h2>
                        ...
                        <?php foreach ($marcas as $marca): ?>
                            <div class="carousel-item">
                                <div class="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all cursor-pointer" 
                                     onclick="window.location.href='fichas.php?marca=<?php echo $marca['id']; ?>'">
                                    ...
                                    <?php endif; ?>
                                    <h3 class="font-semibold text-gray-800 text-sm"><?php echo htmlspecialchars($marca['nome']); ?></h3>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-600 text-lg">Nenhuma marca cadastrada ainda.</p>
                    <?php if ($isLoggedIn && $userRole === "professor"): ?>
                        <a href="marcas.php" class="mt-4 px-6 py-3 bg-senai-blue text-white rounded-lg hover:bg-blue-700 transition-colors inline-block">
