...
$stmt = $pdo->query("
    SELECT f.*, m.nome as marca_nome, c.nome as carroceria_nome 
...
$stmt_marcas = $pdo->query("SELECT COUNT(*) FROM marcas");
$total_marcas = $stmt_marcas->fetchColumn();
...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Gerencie fichas técnicas, marcas e carrocerias do sistema</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-gray-600 text-sm">Total de Marcas</p>
                        <p class="text-2xl font-bold senai-blue"><?php echo $total_marcas; ?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <a href="marcas.php" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                    <i class="fas fa-car text-green-600 text-2xl mr-3"></i>
                    <div>
                        <p class="font-semibold text-green-800">Gerenciar Marcas</p>
                        <p class="text-sm text-green-600">Adicionar/editar marcas</p>
                    </div>
                </a>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Carroceria</th>
                            ...
                            <?php foreach ($fichas as $ficha): ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo htmlspecialchars($ficha['marca_nome'] ?? 'N/A'); ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo htmlspecialchars($ficha['carroceria_nome'] ?? 'N/A'); ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
